...
(function ($) {
	...
	loadYoumax = function() {	
		...
		$('#youmax').append('<div id="youmax-lightbox"><div style="width:100%; position:absolute; top:20%;"><iframe id="youmax-video-lightbox" width="80%" height="500" src="" frameborder="0" allowfullscreen></iframe></div></div>');
